...
public class AdminPermissionsCommand extends PortalsCommand {
	...
	public void execute(CommandSender sender, String[] args) {
		...
		ArrayList<PortalsCommand> commandList = Portals.getCommandManager().getAdminCommands();
	...
	public List<String> onTabComplete(CommandSender sender, String[] args) {
		...
		for (int i =1 ;i<=((int) Math.ceil(Portals.getCommandManager().getAdminCommands().size()/commandsPerPage));i++)
			res.add(i+"");
